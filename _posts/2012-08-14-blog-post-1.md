...
Group theory review
======
Symmetries are mathematically represented by algebraic structures called groups. Formally, a group $\mathcal{G}$ is a set endowed with an operation $\cdot : \mathcal{G} \times \mathcal{G}$
